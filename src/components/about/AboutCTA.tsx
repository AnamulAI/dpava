    ...
    <section className="bg-gray-light py-24 md:py-32 border-b border-dpa-border">
      <div className="container mx-auto px-6 text-center max-w-2xl">
        ...
        <h2 className="text-navy text-3xl md:text-4xl font-bold mb-5">
          Ready to Work With a Reliable Compliance Partner?
        </h2>
        <p className="text-muted-foreground text-base leading-[1.8] mb-10">
          Send your vessel details and current compliance needs. We'll respond
          within 24 hours with a tailored compliance plan.
        </p>
        ...
        <div className="flex flex-wrap justify-center gap-6">
          ...
          <a
            href="/contact"
            className="inline-flex items-center border border-navy text-navy font-semibold px-8 py-3.5 hover:bg-navy hover:text-white transition-colors text-sm"
          >
            Contact Page
          </a>
        </div>
